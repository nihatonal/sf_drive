...
const UploadProfileImg = () => {
    ...
    const onSubmit = async e => {
        ...
        await axios.get(process.env.PUBLIC_URL + '/uploads')
        .then(res => {
          data = res.data;
        })
  ...
  return (
    <Fragment>
      <Header />
        {message && disable !== false ? <Message msg={message} /> : null}
        {message && disable === false ? <Message msg={message} /> : null}
      ...
      <form onSubmit={onSubmit} className={"photo__container"}>
            ...
            <div className={"photo__container_"}>
                <div className={"photo__container_wrapper"}>
                    <div className={imgData ? "photo__container_wrapper-item bg-icon" : "photo__container_wrapper-item" }>
                          <div className="photo__container_wrapper-content">
                            {!imgData ? (
                              <div>
            ...
            <div className={"photo__container-btn-wrapper"}>
                ...
                disabled={disable === false ? "disabled" : null}>
                     {message && disable !== false ? <i className="fa fa-circle-o-notch fa-spin"></i> :
                          "Продолжить"
                     }   
